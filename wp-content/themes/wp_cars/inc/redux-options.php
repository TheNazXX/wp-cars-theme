...
$opt_name = 'cars_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
 ...
 */
 ...
 Redux::setSection(
	$opt_name,
	array(
		'title'            => __( 'Site Settings', 'wp_cars' ),
		'id'               => 'wp_site_settings',
		'customizer_width' => '500px',
		'icon'             => 'fa-solid fa-house',
    'desc'             => __('Settings for Site', 'wp_cars'),
    'fields'            => [
      [
        'id' => 'wp_phone',
        'type' => 'text',
        'title'            => __( 'Phone Number', 'wp_cars' ),
        'subtitle'         => __( 'Type the phone', 'wp_cars' ),
        'customizer_width' => '400px',
      ],
			[
        'id' => 'wp_email',
        'type' => 'text',
        'title'            => __( 'Email', 'wp_cars' ),
        'subtitle'         => __( 'Type the Email', 'wp_cars' ),
        'customizer_width' => '400px',
      ],
			[
				'id'       => 'wp_address',
				'type'     => 'text',
				'title'    => __( 'Address', 'wp_cars' ),
				'subtitle' => __( 'Insert the address', 'wp_cars' ),
				'desc'     => __( 'Address', 'wp_cars' )
			],
			[
        'id' => 'main_banner',
        'type' => 'media',
        'title'            => __( 'Main Banner', 'wp_cars' ),
        'subtitle'         => __( 'Select the Banner', 'wp_cars' ),
        'customizer_width' => '400px',
      ],
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Social Settings', 'wp_cars' ),
	'id'               => 'site_settings_social',
	'icon'						 => 'fa-solid fa-share-from-square',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'Social links', 'wp_cars' ),
	'fields'           => array(
		
		array(
			'id'       => 'fb',
			'type'     => 'text',
			'title'    => __( 'FB Link', 'wp_cars' ),
			'subtitle' => __( 'Insert profile link', 'wp_cars' ),
			'desc'     => __( 'Social link', 'wp_cars' ),
		),
		array(
			'id'       => 'twi',
			'type'     => 'text',
			'title'    => __( 'Twitter Link', 'wp_cars' ),
			'subtitle' => __( 'Insert profile link', 'wp_cars' ),
			'desc'     => __( 'Social link', 'wp_cars' ),
		),
		array(
			'id'       => 'in',
			'type'     => 'text',
			'title'    => __( 'LinkedIn Link', 'wp_cars' ),
			'subtitle' => __( 'Insert profile link', 'wp_cars' ),
			'desc'     => __( 'Social link', 'wp_cars' ),
		),
		array(
			'id'       => 'ins',
			'type'     => 'text',
			'title'    => __( 'Instagram Link', 'wp_cars' ),
			'subtitle' => __( 'Insert profile link', 'wp_cars' ),
			'desc'     => __( 'Social link', 'wp_cars' ),
		),
		array(
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => __( 'Footer Settings', 'wp_cars' ),
		'id'               => 'wp_footer_settings',
		'customizer_width' => '500px',
		'subsection'			 => true,
		'icon'             => 'fa-solid fa-house',
    'desc'             => __('Settings for footer', 'wp_cars'),
    'fields'           => [
      array(
				'id'       => 'title_one',
				'type'     => 'text',
				'title'    => __( 'GET IN TOUCH Title', 'wp_cars' ),
				'subtitle' => __( 'Insert the title', 'wp_cars' ),
				'desc'     => __( 'GET IN TOUCH', 'wp_cars' ),
			),
			array(
				'id'       => 'title_two',
				'type'     => 'text',
				'title'    => __( 'USEFULL LINKS Title', 'wp_cars' ),
				'subtitle' => __( 'Insert the title', 'wp_cars' ),
				'desc'     => __( 'USEFULL LINKS', 'wp_cars' ),
			),
			array(
				'id'       => 'title_three',
				'type'     => 'text',
				'title'    => __( 'CAR GALLERY Title', 'wp_cars' ),
				'subtitle' => __( 'Insert the title', 'wp_cars' ),
				'desc'     => __( 'CAR GALLERY', 'wp_cars' ),
			),
			array(
				'id'       => 'title_four',
				'type'     => 'text',
				'title'    => __( 'ABOUT Title', 'wp_cars' ),
				'subtitle' => __( 'Insert the title', 'wp_cars' ),
				'desc'     => __( 'ABOUT', 'wp_cars' ),
			),
			array(
				'id'       => 'about_footer',
				'type'     => 'editor',
				'title'    => __( 'About Section', 'wp_cars' ),
				'subtitle' => __( 'Insert some text', 'wp_cars' ),
			),
			array(
				'id'       => 'copyrights',
				'type'     => 'editor',
				'title'    => __( 'Copyrights', 'wp_cars' ),
				'subtitle' => __( 'Insert Copyrights', 'wp_cars' ),
			),			
    ],
	)
);
